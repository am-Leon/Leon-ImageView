...
public class SwipeHorizontalTouchListener implements View.OnTouchListener {
    ...
    /**
     * The callback interface used by {@link SwipeHorizontalTouchListener} to inform its client
     ...
     *                  dismiss this view.
     */
    SwipeHorizontalTouchListener(View view, Object token, DismissCallbacks callbacks) {
...
//                    mView.animate()
//                            .scaleX(Math.max(0f, Math.min(1f, 1f - 2f * Math.abs(deltaY) / mViewWidth)))
//                            .scaleY(Math.max(0f, Math.min(1f, 1f - 2f * Math.abs(deltaY) / mViewWidth)))
//                            .setDuration(0).start();
//
                    return true;
                }
